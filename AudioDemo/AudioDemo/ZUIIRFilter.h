...
public:
    ...
    */
    ZUIIRFilter(double *b, double *a, int len, int maxCountPerBuffer);
     ...
     * 
    */
    ZUIIRFilter(double **sos, double g, int sosRows, int sosCols, int maxCountPerBuffer);
    ~ZUIIRFilter();
...
private:
    ...
    list<shared_ptr<ZUIIRFilter>> subFilters; 
